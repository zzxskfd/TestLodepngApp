Usage: Flip all files in <input_folder> with filename extension '.png' (case insensitive) horizentally into <output_folder>. Negelect files that are not PNG files.
